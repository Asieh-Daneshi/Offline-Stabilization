function [datafilename,referenceimage] = makereference_priorref_ND(videoname,refframefilename,badframefilename,...
...
% figure, 
% subplot(1,2,1), imshow(referencematrix(:,:,2)./255)
% subplot(1,2,2), imshow(referenceimage_prior./255)
