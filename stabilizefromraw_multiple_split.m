...
toremmeanlum = 1;                   % If the video has luminance artifacts that has high frequency content
...
coarseframeincrement = 1;          % The step size used when choosing a subset of frames
...
badsamplethreshold = 0.8;%from 0.55          % The thresholdthat is used to locate the strips that had
