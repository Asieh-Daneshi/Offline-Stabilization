...
function stabilizefromraw_single_noUI(videotoanalyse)
    ...
    blinkthreshold = 20;                % This is a maximum change in mean pixel value between
    ...
    smoothsdformeanremoval = 0.25;      % The std. deviation of the smoothing function used by the removemeanlum.m
                                        % function.
    numframestoaverage = 3;             % The number of frame to average toget if you want to remove the influence of
    ...
    samplerateincrement_priorref = 64;  % The multiple of the framerate that is used -> edited from 128
                                        % to obtain the sample rate of the ocular motion
                                        % trace when using the makereference_priorref.m function.
    samplerateincrement = 64;           % The multiple of the framerate that is used -> edited from 128
                                        % to obtain the sample rate of the ocular motion
