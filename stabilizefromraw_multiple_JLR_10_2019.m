...
peakratiodiff = 0.5;   % from 0.1   % Maximum Change in ratio between the secondpeak and firstpeak
...
badsamplethreshold = 0.5; % 0.7;(ND)% The threshold that is used to locate the strips that had
...
priorref_inputstruct = struct('samplerate',[],'vertsearchzone',55,'stripheight',9,...
    'badstripthreshold',badsamplethreshold,'frameincrement',10,'minpercentofgoodstripsperframe',0.4,...
    'numlinesperfullframe',numlinesperfullframe); % Structure that contains input arguments for the makereference_priorref.m function.


%%
analyse_inputstruct = struct('samplerate',[],'vertsearchzone',55,'horisearchzone',[],...
    'startframe',1,'endframe',-1,'stripheight',9,'badstripthreshold',badsamplethreshold,'minpercentofgoodstripsperframe',0.4,...
